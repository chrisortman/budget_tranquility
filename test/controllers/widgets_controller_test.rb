...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { price: @widget.price, quantity: @widget.quantity, sellable: @widget.sellable, title: @widget.title }
    end
  ...
  test "should update widget" do
    patch :update, id: @widget, widget: { price: @widget.price, quantity: @widget.quantity, sellable: @widget.sellable, title: @widget.title }
    assert_redirected_to widget_path(assigns(:widget))
  end
